...
Closing them one at a time oscillates -- the direct solve zeroes the three primitives exactly
and breaks a688/a1618; advgraph re-solves the advice and the pair comes back.  That
is the signature of a system being solved value-wise when it needs to be solved
jointly.
