...
# Phase 1: activate x_7715 and x_34554 via CLEAN load bits (x_36314, x_5643)
target[36314]=1
target[5643]=1
...
for v, x in [(30213, BIGCONST), (22162, H2), (18956, BIGCONST), (24468, H2)]:
...
json.dump({f"x_{i}": val[i] for i in range(NVARS)}, open('achieved5.json','w'))
