...
m=pickle.load(open('/home/user/integer_solver/solve_lab/agentE_work/model3.pkl','rb'))
atoms=m['atoms']; eqt=m['eq_terms']
d=pickle.load(open('/home/user/integer_solver/solve_lab/agentE_work/dag.pkl','rb'))
