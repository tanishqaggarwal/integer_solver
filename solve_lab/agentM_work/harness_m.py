...
import os
if os.path.exists('/home/user/integer_solver/solve_lab/agentM_work/orient.pkl'):
    O=pickle.load(open('/home/user/integer_solver/solve_lab/agentM_work/orient.pkl','rb')); definer=O['definer']; SEQ=O['seq']
else:
    definer,SEQ=_bootstrap(); pickle.dump({'definer':definer,'seq':SEQ}, open('/home/user/integer_solver/solve_lab/agentM_work/orient.pkl','wb'))
