...
override={24601:1, 2081:1, 30213:C2, 22162:C1, 24468:C1, 18956:C2, 4287:1, 9118:126767545623909574255290391153759363968073470399639361054829680359428658595949132261910506, 8731:97171863764434070215824145711260403004952728652948669662983319257693684265837195009100680}
...
for it in range(400):
    ...
    forward()
    if not changed: print(f"  no ready free input to set; stuck at {len(F)} fail"); break
ns['v']=val
F=[i for i in range(len(lines)) if eval(eqcode[i],ns)!=0]
