...
if not inconsistent:
    ...
    pickle.dump({'delta_modp':delta,'pivots':pivots}, open('/tmp/claude-0/-home-user-integer-solver/d279c5f7-7ad9-5092-a944-cb7784834ec0/scratchpad/delta2.pkl','wb'))
    print("saved delta2.pkl")
