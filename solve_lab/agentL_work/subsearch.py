...
M=pickle.load(open('/home/user/integer_solver/solve_lab/agentL_work/full_model.pkl','rb'))
C2=pickle.load(open('/home/user/integer_solver/solve_lab/agentL_work/calib2.pkl','rb'))
TGT=tuple(pickle.load(open('/home/user/integer_solver/solve_lab/agentL_work/target.pkl','rb')))
