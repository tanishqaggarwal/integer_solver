...
v0=[0]*L.NVARS
for _k,_x in json.load(open(os.path.join(HERE,"data","closehit2.json"))).items(): v0[int(_k)]=int(_x)
fw.forward(v0)
FW_ORDER = fw.ORDER
...
json.dump([[n, a, ov] for n, a, ov, _, _ in hits], open(os.path.join(HERE, 'data', 'cheapgates2.json'), 'w'))
